    ...
    public class DateCalculatorTests
    {
		...
		*/	
		...
		public void WhenDaily_AndCurrentScheduledInLastHour_ReturnsTomorrowAtScheduledTime(RunStatus lastRunStatus)
		{
			...
			var date = new DateCalculator(new DateTime(2017, 06, currentDate.Day, 22, currentDate.Hour, currentMinute - 10, DateTimeKind.Utc), trace)
		...
		{
			var date = new DateCalculator(new DateTime(2017, 06, 09, 22, 1, 1, DateTimeKind.Utc), trace).Calculate(Frequency.Daily, 10, 21.30M, lastRunStatus, 1);
			Assert.That(date.Value.Month, Is.EqualTo(6));
		...
		{
			var date = new DateCalculator(new DateTime(2017, 06, 09, 1, 1, 1, DateTimeKind.Utc), trace).Calculate(Frequency.Daily, 10, 21.30M, lastRunStatus, 1);
			Assert.That(date.Value.Month, Is.EqualTo(6));
		...
		{
			var date = new DateCalculator(new DateTime(2017, 06, 09,1,1,1, DateTimeKind.Utc), trace).Calculate(Frequency.Weekly, 10, 21.30M, lastRunStatus, 1);
			Assert.That(date.Value.Month, Is.EqualTo(6));
		...
		{
			var date = new DateCalculator(new DateTime(2017, 06, 09,1,1,1,DateTimeKind.Utc), trace).Calculate(Frequency.Weekly, 1, 21.30M, lastRunStatus, 1);
			Assert.That(date.Value.Month, Is.EqualTo(6));
		...
		{
			var date = new DateCalculator(new DateTime(2017, 06, 11,1,1,1,DateTimeKind.Utc), trace).Calculate(Frequency.Monthly, 10, 21.30M, lastRunStatus, 1);
		...
		{
			var date = new DateCalculator(new DateTime(2017, 06, 09,1,1,1,DateTimeKind.Utc), trace).Calculate(Frequency.Monthly, 10, 21.30M, lastRunStatus, 1);
			Assert.That(date.Value.Month, Is.EqualTo(6));
			Assert.That(date.Value.Day, Is.EqualTo(10));
			Assert.That(date.Value.Hour, Is.EqualTo(21));
			Assert.That(date.Value.Minute, Is.EqualTo(30));
		...
		{
			var date = new DateCalculator(new DateTime(2017, 05, 31, 22,1,1, DateTimeKind.Utc), trace).Calculate(Frequency.Monthly, 30, 21.30M, lastRunStatus, 1);
			Assert.That(date.Value.Month, Is.EqualTo(6));
